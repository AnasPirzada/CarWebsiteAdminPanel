...
export const index = ({ PageName }) => {
  return (
    <div>
      ...
      <div className='px-0 px-md-3 maindivres'>
        <Row className='d-flex justify-content-between align-items-center navres'>
          <Col lg={8} sm={4}>
            <div className=' w-100 bg-white rounded-3'>
              <img src='/Search' alt='' />
              <input
          ...
          >
            <Row className='moblook d-flex justify-content-between align-items-center'>
              <Col>
                <img src='/Frame 1261153402.svg' alt='' />
              </Col>
              <Col
            ...
            <div className='moblook text-end'>
              <div className='my-1 d-flex justify-content-center align-items-center'>
                <p
                  style={{
                    fontSize: '14px',
